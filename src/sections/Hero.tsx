...
export const Hero = () => {
  ...
  <section className="h-[492px] md:h-[800px] flex items-center overflow-hidden relative [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)]" style={{
    ...
    {/* End planet */}
    {/* Start ring 1 */}
    <div className="absolute h-[344px] w-[344px] md:h-[580px] md:w-[590px] border border-white opacity-20 rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
